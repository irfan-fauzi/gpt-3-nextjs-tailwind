          ...
          <div className="flex  items-center">
            ...
            <div className="w-4/12 ">
              <div className="flex gap-2 justify-end">
                ...
                <button className={`${!showMenu ? 'fixed z-[9999]': 'static'} lg:hidden border-gray-50 cursor-pointer lg:static top-9 bg-gradient p-1 `} onClick={() => setShowMenu(!showMenu)}>{showMenu ? (<RiMenu3Line color='#fff' size={35} />) : (<RiCloseLine color='#fff' size={35}/>)}</button>
              </div>
