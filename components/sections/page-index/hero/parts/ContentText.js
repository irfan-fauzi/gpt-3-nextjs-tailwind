    ...
    <div className="md:w-7/12 ">
        ...
        <h1 className="xl:text-6xl xl:leading-tight lg:text-5xl text-[2rem] leading-10 md:leading-none font-bold text-gradient text-transparent">{contentText.heading}</h1>
          <Gap className="h-6"/>
            ...
            <Gap className="h-6"/>
            <form>
              <input type="text" className="bg-[#052D56] lg:w-7/12 md:w-auto w-full lg:py-4 lg:px-8 md:py-2 py-3 px-6 text-gray-300 text-left md:text-left" placeholder="your email address"/>
            ...
            <div className="flex flex-col">
              ...
              <p className="text-gray-500 font-light md:text-lg text-md md:text-left  text-center">1,600 people requested access a visit in last 24 hours</p>
            </div>
